...
# def deal(hand):
#     drawn_card = (random.choice(cards) * 2)
...
# print(f"Here's your hand: {players_cards}")
# print(f"Here's the dealers hand: {dealers_cards[0]}")

# hit_or_stick = input("Would you like another card? Y or N... ")
...
# def draw_card():
#   # if first_card <= 20:
#   #   input("Do you want another card? Y or N... ").lower()
#   #   if input == "y":
#   #       select_card
#   # else:
...
def compare_hands(player_score, dealer_score):
  ...
  # if dealer_score > player_score and dealer_score is not > 21:
  #   print("Dealer Wins")
  #   game_over = True
  # elif player_score > dealer_score and player_score is not > 21:
  #   print("Player Wins")
  #   game_over = True
  # else:
  #   print("Draw")
